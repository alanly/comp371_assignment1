...
glm::mat4 Model::GetWorldMatrix() const
{
	...
	glm::mat4 rotatedView    = glm::rotate(translatedView, mRotationAngleInDegrees, mRotationAxis);	
	glm::mat4 scaledView     = glm::scale(rotatedView, mScaling);

	// @TODO 4 - Maybe you should use the parent world transform when you do hierarchical modeling
	glm::mat4 worldMatrix = scaledView;
